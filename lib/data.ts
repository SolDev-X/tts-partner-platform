    ...
    variantRules: [
      {
        ...
        disclaimer:
          "我们会依据平台审核标准，协助客户完成材料准备与提交，全程跟进审核进度。如因平台审核未通过，将退还本次服务费用；具体处理方式以下单前的服务约定为准。",
      },
    ],
    faqs: [
      {
    ...
    variantRules: [
      {
        ...
        disclaimer:
          "我们会依据平台审核标准，协助客户完成一品多仓布局的材料准备与提交，提交后预计 7 个工作日内显示结果，请耐心等待。开通后我们会提供官方的 POP 混发双向商品管理操作指引，协助您完成后续操作。如因平台审核未通过（不含因客户提供材料不实等自身原因导致的情况），将退还本次服务费用。",
      },
      {
        match: {mode: "category"},
        requiredMaterials: [
        ...
        disclaimer:
          "我们会依据平台审核标准，协助客户完成权限开通的材料准备与提交，全程跟进审核进度。如因平台审核未通过（不含因客户提供材料不实等自身原因导致的情况），将退还本次服务费用。",
      },
    ],
    faqs: [
      {
